...
public final class CarParkServiceGrpc {
  ...
  public static final io.grpc.MethodDescriptor<org.sample.park.Empty,
      ...
      io.grpc.MethodDescriptor.<org.sample.park.Empty, org.sample.park.LogMessage>newBuilder()
          ...
          .build();
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<org.sample.park.StatusRequest,
      org.sample.park.CommandResponse> METHOD_GET_STATUS =
      io.grpc.MethodDescriptor.<org.sample.park.StatusRequest, org.sample.park.CommandResponse>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "park.CarParkService", "GetStatus"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              org.sample.park.StatusRequest.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              org.sample.park.CommandResponse.getDefaultInstance()))
          .build();
  ...
  public static abstract class CarParkServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getStatus(org.sample.park.StatusRequest request,
        io.grpc.stub.StreamObserver<org.sample.park.CommandResponse> responseObserver) {
  ...
  public static final class CarParkServiceBlockingStub extends io.grpc.stub.AbstractStub<CarParkServiceBlockingStub> {
    ...
    /**
     */
    public org.sample.park.CommandResponse getStatus(org.sample.park.StatusRequest request) {
      return blockingUnaryCall(
  ...
  public static final class CarParkServiceFutureStub extends io.grpc.stub.AbstractStub<CarParkServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<org.sample.park.CommandResponse> getStatus(
        org.sample.park.StatusRequest request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_GET_STATUS:
          serviceImpl.getStatus((org.sample.park.StatusRequest) request,
              (io.grpc.stub.StreamObserver<org.sample.park.CommandResponse>) responseObserver);
          break;
        default:
